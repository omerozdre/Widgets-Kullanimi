    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Center(
          child: Column(
            children: [
              Text(alinanVeri),//tf den gelen alinanveri yi gösteriyoruz
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: TextField(
                  controller: tfController,//tfcontroller sayesinden üzerinden verileri okuyacağız
                  decoration: InputDecoration(hintText: "veri"),
                  keyboardType: TextInputType.number,//klavye tipi
                  obscureText: true, //texti gizleme
                ),
              ),
              ElevatedButton(onPressed: (){
                setState(() {
                  alinanVeri = tfController.text;//alinanveriye aktarıcak ve arayüzde göreceğiz(ext(alinanVeri)).
                });//butona basıldığında tf deki veri alinan veriye gider setstate olduğu içi build metodunu güncelliyor
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  ...
                  SizedBox(width: 48, height: 48,
                      child: Image.network("http://kasimadalan.pe.hu/yemekler/resimler/$resimAdi")),// Image.asset("resimler/$resimAdi"),
                  ElevatedButton(onPressed: (){
                    setState(() {
                      resimAdi = "ayran.png";
                    });
                ...
                children: [
                  SizedBox(width: 200,
                    child: RadioListTile(
                        ...
                        value: 1,//temsil ediyor
                        groupValue: radioDeger,//ilk baştta radio değer 0 ikside seçilmiyor eğer seçersek 1 getirecek ve radiodeğer 1 olacak setstate sayfayı güncelleyecek
                        onChanged: (veri){
                          setState(() {
                            radioDeger = veri!;
                          });
                  ...
                  SizedBox(width: 200,
                    child: RadioListTile(
                        ...
                        value: 2,//temsil ediyor
                        groupValue: radioDeger,//radio değer hangisi ise o seçilecek
                        onChanged: (veri){
                          setState(() {
                            radioDeger = veri!;
              ...
              ElevatedButton(onPressed: (){
                print("Switch Durum $switckontrol");
